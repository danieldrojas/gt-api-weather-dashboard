$(document).ready(function () {
    ...
    var storedCitiesProperties = localStorage.getItem('citiesProperties')
    ...
    function JSONresponse(city) {
        ...
        $.ajax({
            ...
            propertiesArray = [cityName, temp, hum, windSpeed]
...
//Adding properties to array 
          function cityProperties() {
                    ...
                    $(".card-body").append($("<h6>" + 'Wind Spped: ' + windSpeed + ' MPH' + "</h6>"))
                }
            ...
            $.ajax({
                ...
                var uvIndex = responseForecast.daily[0].uvi
                console.log(uvIndex)

                cityProperties()

                if (uvIndex < 3) {
                    $(".card-body").append($("<h6>" + 'UV Indexs: ' + "<card id='color-uv' style='background-color: green'>" + uvIndex + "</card>" + "</h6> "))
              } else if (uvIndex < 7) {
                    $(".card-body").append($("<h6>" + 'UV Indexs: ' + "<card id='color-uv' style='background-color: orange'>" + uvIndex + "</card>" + "</h6> "))
                } else {
                    $(".card-body").append($("<h6>" + 'UV Indexs: ' + "<card id='color-uv' style='background-color: red'>" + uvIndex + "</card>" + "</h6> "))
                }
